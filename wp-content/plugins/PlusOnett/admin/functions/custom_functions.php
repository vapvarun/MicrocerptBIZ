...
function templ_show_facebook_button_action()
{
	if(templ_is_facebook_button())
	{
     ...
     <div class="flike">  <div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script>
     <fb:like href="<?php get_permalink();?>" send="false" layout="button_count" width="85" show_faces="true" font=""></fb:like></div>
...
//		$return_str = '<a href="'.get_option('home').'/">';
		$return_str = '<a href="http://www.microcerpt.com/">';
