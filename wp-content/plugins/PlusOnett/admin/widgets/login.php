...
function widget_register_new_user( $user_login, $user_email ) {
	...
	if($user_id>0)
	{
		...
		$userName = isset($_POST['user_login']) ? stripslashes($_POST['user_login']) : '';
		...
		$subject = apply_filters('templ_registration_email_content', 'Registration Confirmation Email');
		...
		wp_mail($fromEmail, $subject , $message,$headers);
	}
