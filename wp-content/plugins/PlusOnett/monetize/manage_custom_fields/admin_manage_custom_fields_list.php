...
<table width="100%"  class="widefat post" >
  <thead>
    <tr>
      <th><strong><?php _e('Admin Title','templatic');?></strong></th>
      <th><strong><?php _e('Post Type','templatic');?></strong></th>
...
if($post_meta_info){
	...
	?>
	 ...
	 <a href="javascript:void(0);showdetail('<?php echo $post_meta_info_obj->cid;?>');"><?php _e('Detail','templatic');?></a>| 
      <a href="<?php echo site_url();?>/wp-admin/admin.php?page=custom&cf=<?php echo $post_meta_info_obj->cid;?>#option_add_custom_fields"><?php _e('Edit','templatic');?></a> <?php if($post_meta_info_obj->is_delete=='0'){?>| 
