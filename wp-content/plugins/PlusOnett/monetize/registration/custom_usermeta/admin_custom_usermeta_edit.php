...
if($_REQUEST['cf'])
{
	 _e('Edit Custom User Meta','templatic');	
}else
{
	 _e('Add Custom User Meta','templatic');
}
?></h3>
<?php
...
<br />    <span><?php _e('Select type','templatic');?></span>
  ...
  <tr>
  <td ><strong><?php _e('Title : ','templatic');?></strong></td>
...
<br />    <span><?php _e('Title which you wish to display in frontend','templatic');?></span>
   ...
   <tr>
  <td ><strong><?php _e('Field Description : ','templatic');?></strong></td>
  <td align="left"><input type="text"name="admin_desc" id="admin_desc" value="<?php echo $post_val->admin_desc;?>" size="50" />
<br />    <span><?php _e('Field Description which will display below field tag','templatic');?></span>
  </td>
  </tr>
  <tr>
 ...
 <tr id="admin_label_id"  <?php if($post_val->ctype=='head'){?> style="display:none;" <?php }else{?>  style="display:block;" <?php }?>>
  ...
  <td ><strong><?php _e('Display on Registration Page? : ','templatic');?></strong></td>
  <td align="left">
  ...
  <option value="0" <?php if($post_val->show_on_listing=='0'){ echo 'selected="selected"';}?>><?php _e('No','templatic');?></option>
      ...
      <br />    <span><?php _e('Do you want to display this on Registration page ?','templatic');?></span>
  </td>
  </tr>
  ...
  <option value="0" <?php if($post_val->show_on_detail=='0'){ echo 'selected="selected"';}?>><?php _e('No','templatic');?></option>
      ...
      <br />    <span><?php _e('Want to show this on Profile page ?','templatic');?></span>
  </td>
  </tr>
    <tr>
  <td >&nbsp;</td>
