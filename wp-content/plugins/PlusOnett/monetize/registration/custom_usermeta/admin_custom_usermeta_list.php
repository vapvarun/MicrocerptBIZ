...
<table width="100%"  class="widefat post" >
  <thead>
    <tr>
      <th><strong><?php _e('Title','templatic');?></strong></th>
      <th align="center"><strong><?php _e('Type','templatic');?></strong></th>
      <th align="center"><strong><?php _e('Is Active','templatic');?></strong></th>
      <th><strong><?php _e('Display Order','templatic');?></strong></th>
...
if($post_meta_info){
	...
	?>
     <tr>
      ...
      <td>
	 <a href="javascript:void(0);showdetail('<?php echo $post_meta_info_obj->cid;?>');"><?php _e('Detail','templatic');?></a>| 
      <a href="<?php echo site_url();?>/wp-admin/admin.php?page=custom_usermeta&cf=<?php echo $post_meta_info_obj->cid;?>#option_add_custom_usermeta"><?php _e('Edit','templatic');?></a> <?php if($post_meta_info_obj->is_delete=='0'){?>| 
	  <a href="javascript:void(0);" onclick="return confirm_delete('<?php echo $post_meta_info_obj->cid;?>');"><?php _e('Delete','templatic');?></a><?php }?>
      </td>
      </tr>
