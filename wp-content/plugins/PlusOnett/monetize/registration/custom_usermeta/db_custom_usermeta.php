...
{
	add_submenu_page('templatic_wp_admin_menu', __("Manage Custom Usermeta",'templatic'), __("Custom Usermeta",'templatic'), TEMPL_ACCESS_USER, 'custom_usermeta', 'manage_custom_usermeta');
}
