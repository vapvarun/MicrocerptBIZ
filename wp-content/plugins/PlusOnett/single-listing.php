...
<div class="content-title"> xxx<?php echo templ_page_title_filter(get_the_title()); //page tilte filter?> </div>
...
<div class="entry">
  <div <?php post_class('single clear'); ?> id="post_<?php the_ID(); ?>">
   ...
   var $n = jQuery.noConflict();
       ...
       <?php the_content(); ?> 
	   <?php
	   if(get_post_custom_listing_single_page($post->ID,' <li><span>{#TITLE#}</span> : {#VALUE#}</li>') != ''){
			?>
