...
1. Extract the files. Upload `commentcontrol.php` to the `/wp-content/plugins/` directory. This is the only file you need, you don't need to upload any of the others.
