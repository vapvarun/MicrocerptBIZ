...
<?php 
	...
	$args = array(	
		...
		'comment_notes_after' =>'',
		'comment_notes_before' =>'<p class="comment-notes">' . __( 'Your email address will not be published.' , 'cosmotheme' ) . '</p>',
        'logged_in_as' =>'<p class="logged-in-as">' . __( 'Logged in as' ,'cosmotheme' ) . ' <a href="' . home_url('/wp-admin/profile.php') . '">' . get_the_author_meta( 'nickname' , get_current_user_id() ) . '</a>. <a href="' . wp_logout_url( get_permalink( $post -> ID ) ) .'" title="' . __( 'Log out of this account' , 'cosmotheme' ) . '">' . __( 'Log out?' , 'cosmotheme' ) . ' </a></p>',		
