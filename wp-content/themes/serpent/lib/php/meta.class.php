		...
		function save(){
            ...
            if( 'slideshow' == $res ){
                ...
                foreach( $data as $field ){
                    if( $field[ 'name' ] == 'box[res_type][]' ){
                        $res_type = $field[ 'value' ];
                        break;
                    }
                    if( $field[ 'name' ] == 'box[slide_id][]' ){
                        $imageID = $field[ 'value' ];
                    }
                    if( $field[ 'name' ] == 'box[resources][]' ){
                        $postID = $field[ 'value' ];
                    }
                }

                $slideshow_settings = self::get_meta( $post_id , 'slidesettings' );
