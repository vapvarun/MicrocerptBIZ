        ...
        static function add_divider( $atts , $content ){
     	...
     	static function add_toggle( $atts , $content ){
        	...
        	if($hide == 'true'){
     		...
     		return '<div class="cosmo-toggle"><div class="'.$div_class.'"><h2 class="cosmo-toggle-h2"><a class="'.$ico_class.'"><span class="title_closed '.$title_closed_class.'">'.__($title_open).'</span><span class="title_open '.$title_open_class.'" >'.__($title_closed).'</span></a></h2></div><div class="cosmo-toggle-container '.$title_open_class.'">'.do_shortcode(de_remove_wpautop($content)).'</div></div>';
        }
