        ...
        function get_tweets( $username , $number , $classes = '' , $before = "<div class='tweet_item'><p>" , $after = "</p></div>", $static_class = '' ){
        	if(trim($username) == ''){
        		$result[0] = '<div class="cosmo_twitter">';
	  			...
	  			$result[1]  = '<a class="i_join_us '.$static_class.'" href="http://twitter.com/" title="'.__('Follow us','cosmotheme').'">'.__('Follow us','cosmotheme').'</a>';
	  			return $result;
        	}
            ...
            if( strlen( $classes ) ){  /*This is for the front page presentation*/
	            ...
	            $result[1]  = '<a class="i_join_us '.$static_class.'" href="http://twitter.com/'.$username.'" title="'.__('Follow us','cosmotheme').'">'.__('Follow us','cosmotheme').'</a>';
            }
