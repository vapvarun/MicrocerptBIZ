...
<div id="loading_" style="position:absolute; margin-left:-77px; margin-top:-39px; top:50%; left:50%;display:none"><object width="100" height="100" type="application/x-shockwave-flash" data="<?php echo get_template_directory_uri() ?>/images/preloader.swf" id="ajax-indicator-swf" style="visibility: visible;">
